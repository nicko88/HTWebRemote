...
namespace HTWebRemote.Forms
{
    public partial class Donate : Form
    {
        ...
        public Donate()
        {
            ...
            sb.AppendLine("Thank you for using HTWebRemote!");
            sb.AppendLine();
            sb.AppendLine("I developed this in my spare time for my own use and for the use of other HT enthusiasts.");
            sb.AppendLine();
        ...
        {
            System.Diagnostics.Process.Start("https://www.paypal.com/donate?business=NHTWA7JUCHJFG&no_recurring=1&item_name=HTWebRemote&currency_code=USD");
        }
